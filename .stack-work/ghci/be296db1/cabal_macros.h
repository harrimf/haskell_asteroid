...
#ifndef VERSION_asteroid
#define VERSION_asteroid "0.1.0.0"
#endif /* VERSION_asteroid */
#ifndef MIN_VERSION_asteroid
#define MIN_VERSION_asteroid(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_asteroid */
...
#define CURRENT_COMPONENT_ID "asteroid-0.1.0.0-2EF0tLCRs2oACLIqlY54ZX-asteroid"
